...
@Slf4j
@Component
public class HelloTraceV2 { // 싱클톤으로 쓰는 목적
    ...
    // V2에서 추가
    public TraceStatus beginSync(TraceId beforeTraceId, String message) { // 걍 객체 리턴
        TraceId nextId = beforeTraceId.createNextId(); // Id유지, Level +1
